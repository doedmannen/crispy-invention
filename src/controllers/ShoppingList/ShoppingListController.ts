...
export class ShoppingListController extends CrudController {
    ...
    public create(req: Request<import("express-serve-static-core").ParamsDictionary, ShoppingList, ShoppingList, import("qs").ParsedQs>, res: Response<ShoppingList>): void {

        let shoppingList:ShoppingList = Object.assign(new ShoppingList(), req.body);
    ...
    public read(req: Request<import("express-serve-static-core").ParamsDictionary, any, any, import("qs").ParsedQs>, res: Response<Array<ShoppingList>>): void {
    ...
    public update(req: Request<import("express-serve-static-core").ParamsDictionary, ShoppingList, ShoppingList, import("qs").ParsedQs>, res: Response<ShoppingList>): void {

...
export const db: Database = new sqlite3.Database('./database/data.db', sqlite3.OPEN_READWRITE, (err: Error) => {
    if(err){
        return console.log('Failed to connect to ./database/data.db...', err.message);
    }
